...
CANDIDATE_ALIASES = {
    ...
    "augusto": ("augusto-cury", "Augusto Cury"),
    "edmilson costa": ("edmilson-costa", "Edmilson Costa"),
    "edmilson dias": ("edmilson-costa", "Edmilson Costa"),
    "hertz dias": ("hertz-dias", "Hertz Dias"),
    "hertz": ("hertz-dias", "Hertz Dias"),
    "samara martins": ("samara-martins", "Samara Martins"),
    "samara": ("samara-martins", "Samara Martins"),
    "wilson grassi": ("wilson-grassi", "Wilson Grassi"),
    "wilson": ("wilson-grassi", "Wilson Grassi"),
    "clariana barao": ("clariana-barao", "Clariana Barão"),
    "clariana zacarkim barao": ("clariana-barao", "Clariana Barão"),
