...
CANDIDATE_ALIASES = {
    ...
    "clariana-barao": "clariana-barao",
    "clariana zacarkim barao": "clariana-barao",
    "rui costa pimenta": "rui-costa-pimenta",
    "rui-costa-pimenta": "rui-costa-pimenta",
    "pablo marcal": "pablo-marcal",
    "pablo-marcal": "pablo-marcal",
    # Historical aliases (kept for archived articles, not in official 13)
    "tarcisio": "tarcisio",
