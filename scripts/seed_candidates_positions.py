...
CANDIDATE_WIKI_TITLES: dict[str, str] = {
    ...
    "samara-martins": "Samara_Martins",
    "wilson-grassi": "Wilson_Grassi",
    "clariana-barao": "Clariana_Barão",
    "rui-costa-pimenta": "Rui_Costa_Pimenta",
    "pablo-marcal": "Pablo_Marçal",
}
...
PARTY_IDEOLOGICAL_PROFILES: dict[str, dict[str, str]] = {
    ...
    "caiado": {
        "armas": "PSD: favorável ao porte de armas; discurso alinhado ao agronegócio e à segurança rural. Registro TSE 2026 como PSD com Gilberto Kassab na vice.",
        "meio_ambiente": "PSD: defende o agronegócio; posição crítica a restrições ambientais excessivas.",
        "lgbtq": "PSD: postura conservadora; contrário a políticas de identidade de gênero.",
        "aborto": "PSD: contrário ao aborto; defende vida desde a concepção.",
        "previdencia": "PSD: apoiou reforma da previdência de 2019.",
        "impostos": "PSD: defende reforma tributária com simplificação e redução de carga.",
        "midia": "PSD: contrário à censura de redes sociais.",
        "indigenas": "PSD: favorável ao marco temporal; defende segurança jurídica da propriedade rural.",
        "educacao": "PSD: defende educação de qualidade, ensino técnico e profissional.",
        "seguranca": "PSD: linha dura, endurecimento de penas e fortalecimento policial.",
        "corrupcao": "PSD: discurso anticorrupção, transparência pública.",
    },
    "zema": {
    ...
    "augusto-cury": {
        "armas": "Avante: posição moderada; defende controle responsável, não pauta central.",
        "meio_ambiente": "Avante: defende equilíbrio entre preservação e desenvolvimento.",
        "lgbtq": "Avante: postura pragmática; sem ativismo ideológico forte.",
        "aborto": "Avante: conservador; contrário à liberalização ampla.",
        "previdencia": "Avante: apoiou reforma da previdência; foco em equilíbrio fiscal.",
        "impostos": "Avante: defende simplificação tributária e redução de burocracia.",
        "midia": "Avante: moderado sobre regulação de plataformas.",
        "indigenas": "Avante: pragmático; sem posição extrema.",
        "educacao": "Avante: defende educação e saúde mental como prioridade.",
        "seguranca": "Avante: defende segurança pública com valorização policial.",
        "corrupcao": "Avante: discurso anticorrupção; defende transparência.",
    },
    "edmilson-costa": {
        "armas": "PCB: contrário ao porte de armas; defende desarmamento e políticas sociais de prevenção.",
        "meio_ambiente": "PCB: defesa intransigente do meio ambiente, crítica ao agronegócio predatório.",
        "lgbtq": "PCB: favorável aos direitos LGBTQ+, defesa da diversidade.",
        "aborto": "PCB: favorável à descriminalização e direito ao aborto legal e gratuito.",
        "previdencia": "PCB: contrário à reforma da previdência de 2019; defende previdência pública e universal.",
        "impostos": "PCB: defende reforma tributária progressiva, taxação de grandes fortunas.",
        "midia": "PCB: favorável à regulação democrática da mídia, combate à concentração.",
        "indigenas": "PCB: favorável à demarcação, contrário ao marco temporal, defesa dos povos originários.",
        "educacao": "PCB: defesa da educação pública, gratuita e de qualidade, contrária a vouchers.",
        "seguranca": "PCB: defende políticas sociais, crítica ao encarceramento em massa.",
        "corrupcao": "PCB: discurso anticorrupção com crítica ao capital e transparência pública.",
    },
    "hertz-dias": {
        "armas": "PSTU: contrário ao porte de armas; defende políticas sociais.",
        "meio_ambiente": "PSTU: ecossocialista; defesa do meio ambiente contra o capitalismo predatório.",
        "lgbtq": "PSTU: favorável aos direitos LGBTQ+, defesa intransigente.",
        "aborto": "PSTU: favorável à descriminalização e legalização do aborto.",
        "previdencia": "PSTU: contrário à reforma da previdência; defende previdência pública.",
        "impostos": "PSTU: defende não pagamento da dívida pública, taxação dos ricos.",
        "midia": "PSTU: favorável à regulação democrática, contra monopólios de mídia.",
        "indigenas": "PSTU: favorável à demarcação imediata, contra marco temporal.",
        "educacao": "PSTU: defesa da educação pública, contra privatizações.",
        "seguranca": "PSTU: crítica à repressão policial; defende políticas sociais.",
        "corrupcao": "PSTU: discurso anticorrupção, crítica ao sistema capitalista.",
    },
    "samara-martins": {
        "armas": "UP: contrária ao porte de armas; defesa do desarmamento.",
        "meio_ambiente": "UP: defesa do meio ambiente, crítica ao agronegócio e à mineração predatória.",
        "lgbtq": "UP: favorável aos direitos LGBTQ+, defesa da diversidade.",
        "aborto": "UP: favorável à descriminalização e legalização do aborto.",
        "previdencia": "UP: contrária à reforma da previdência; defesa da previdência pública.",
        "impostos": "UP: defende taxação de grandes fortunas, reforma tributária popular.",
        "midia": "UP: favorável à regulação democrática da mídia.",
        "indigenas": "UP: favorável à demarcação, contra marco temporal.",
        "educacao": "UP: defesa da educação pública, gratuita e de qualidade.",
        "seguranca": "UP: defende políticas sociais, crítica ao encarceramento.",
        "corrupcao": "UP: discurso anticorrupção, defesa do poder popular.",
    },
    "wilson-grassi": {
        "armas": "Democrata: posição moderada; defesa da proteção animal e segurança.",
        "meio_ambiente": "Democrata: defesa da proteção animal e meio ambiente.",
        "lgbtq": "Democrata: postura conservadora moderada.",
        "aborto": "Democrata: conservador; contrário à liberalização ampla.",
        "previdencia": "Democrata: defende previdência pública com equilíbrio.",
        "impostos": "Democrata: defende simplificação tributária.",
        "midia": "Democrata: moderado sobre regulação.",
        "indigenas": "Democrata: pragmático; sem posição extrema.",
        "educacao": "Democrata: defende educação e proteção animal.",
        "seguranca": "Democrata: defende segurança pública.",
        "corrupcao": "Democrata: discurso anticorrupção, transparência.",
    },
    "clariana-barao": {
        "armas": "DC: posição conservadora; contrária à liberalização ampla.",
        "meio_ambiente": "DC: defesa da preservação com desenvolvimento sustentável.",
        "lgbtq": "DC: postura conservadora cristã.",
        "aborto": "DC: contrária ao aborto; defende vida desde a concepção.",
        "previdencia": "DC: defende previdência com equilíbrio fiscal.",
        "impostos": "DC: defende reforma tributária e justiça fiscal.",
        "midia": "DC: favorável à regulação responsável.",
        "indigenas": "DC: defende proteção com segurança jurídica.",
        "educacao": "DC: forte defesa da educação e da família.",
        "seguranca": "DC: defende segurança pública e proteção social.",
        "corrupcao": "DC: discurso anticorrupção, ética cristã.",
    },
    "rui-costa-pimenta": {
        "armas": "PCO: contrário ao porte de armas; crítica à liberação.",
        "meio_ambiente": "PCO: defesa do meio ambiente contra o capital estrangeiro.",
        "lgbtq": "PCO: favorável aos direitos LGBTQ+ sob ótica de classe.",
        "aborto": "PCO: favorável à descriminalização.",
        "previdencia": "PCO: contrário à reforma da previdência.",
        "impostos": "PCO: defende estatização e não pagamento da dívida.",
        "midia": "PCO: crítico à grande mídia, defende imprensa operária.",
        "indigenas": "PCO: favorável à demarcação, contra marco temporal.",
        "educacao": "PCO: defesa da educação pública estatal.",
        "seguranca": "PCO: crítica à repressão, defesa de políticas sociais.",
        "corrupcao": "PCO: discurso anticorrupção, crítica ao capitalismo.",
    },
    "pablo-marcal": {
        "armas": "PRTB: favorável à flexibilização do acesso a armas.",
        "meio_ambiente": "PRTB: posição desenvolvimentista, crítica a restrições excessivas.",
        "lgbtq": "PRTB: postura conservadora.",
        "aborto": "PRTB: contrário ao aborto.",
        "previdencia": "PRTB: apoiou reforma da previdência; defende capitalização.",
        "impostos": "PRTB: defende redução de impostos e livre mercado.",
        "midia": "PRTB: crítico à regulação de redes.",
        "indigenas": "PRTB: favorável ao marco temporal.",
        "educacao": "PRTB: defende educação com liberdade, menos intervenção estatal.",
        "seguranca": "PRTB: linha dura, defende endurecimento de penas.",
        "corrupcao": "PRTB: discurso anticorrupção, transparência.",
    },
    "renan-santos": {
