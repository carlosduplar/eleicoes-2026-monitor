...
Dispatched by conductor.ps1 at 2026-03-09T16:32:28Z
Model: gpt-5.3-codex

## Instructions

Read and implement the spec in `plans/phase-03-arch.md`.
...
2. Commit all changes: `git add -A && git commit -m "feat: phase 03 complete"`
3. Create the sentinel: `New-Item -Path plans/phase-03-arch.DONE -ItemType File -Force`
4. STOP — do not proceed to the next phase.

## Escalation protocol

If you encounter the same error more than 3 times in a row:
1. Write `tasks/phase-03/ESCALATION.md` with:
...
- `PLAN.md`                           master plan
- `plans/phase-03-arch.md`       this phase spec
