...
Dispatched by conductor.ps1 at 2026-03-09T18:48:34Z
Model: gpt-5.3-codex

## Instructions

Read and implement the spec in `plans/phase-04-arch.md`.
...
2. Commit all changes: `git add -A && git commit -m "feat: phase 04 complete"`
3. Create the sentinel: `New-Item -Path plans/phase-04-arch.DONE -ItemType File -Force`
4. STOP — do not proceed to the next phase.

## Escalation protocol

If you encounter the same error more than 3 times in a row:
1. Write `tasks/phase-04/ESCALATION.md` with:
...
- `PLAN.md`                           master plan
- `plans/phase-04-arch.md`       this phase spec
